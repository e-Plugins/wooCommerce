...
Use this plugin to add support for iDEAL, Bancontact, GiroPay, EPS, Sofort,Credit card and Paypal to your WooCommerce webstore using the DigiWallet.nl paymethods.
...
= 5.0.5 =
replace CUrl with WP_Http 
= 5.0.6 =
fix plugin in case active WP Multisite
= 5.0.7 =
execute query when plugin loaded
= 5.0.8 =
set default select bank|country to blank & update translation
= 5.0.9 =
Minor bug fixes and URL update
= 5.1.0 =
New payment methods
= 5.1.1 =
Minor changes
